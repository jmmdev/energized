    ...
    return (
        <div className="flex gap-4 items-center">
            <div className="flex gap-2 items-center">
                ...
                <button className="group flex w-12 p-0.5 rounded-full border-2 border-foreground hover:border-highlight-hover bg-background cursor-pointer" onClick={switchTheme}>
